...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fir.autotvin_x_V_data_V.dat"
         "c.fir.autotvin_x_V_keep_V.dat"
         "c.fir.autotvin_x_V_strb_V.dat"
         "c.fir.autotvin_x_V_last_V.dat"
         "c.fir.autotvin_coeffs.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fir.autotvout_y_V_data_V.dat"
         "rtl.fir.autotvout_y_V_keep_V.dat"
         "rtl.fir.autotvout_y_V_strb_V.dat"
         "rtl.fir.autotvout_y_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
