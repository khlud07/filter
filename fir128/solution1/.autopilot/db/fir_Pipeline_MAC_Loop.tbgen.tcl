...
set C_modelArgList {
	...
	{ shift_reg int 16 regular {array 128 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "ptr_load", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "shift_reg", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ shift_reg_address0 sc_out sc_lv 7 signal 2 } 
	{ shift_reg_ce0 sc_out sc_logic 1 signal 2 } 
	{ shift_reg_q0 sc_in sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "shift_reg_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "shift_reg", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_5s_16s_27s_27_4_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	shift_reg { ap_memory {  { shift_reg_address0 mem_address 1 7 }  { shift_reg_ce0 mem_ce 1 1 }  { shift_reg_q0 in_data 0 16 } } }
}
