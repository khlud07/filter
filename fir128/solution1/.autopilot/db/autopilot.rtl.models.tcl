set SynModuleInfo {
  {SRCNAME fir_Pipeline_VITIS_LOOP_13_1 MODELNAME fir_Pipeline_VITIS_LOOP_13_1 RTLNAME fir_fir_Pipeline_VITIS_LOOP_13_1
    SUBMODULES {
  ...
  {SRCNAME fir MODELNAME fir RTLNAME fir IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME fir_c_RAM_AUTO_1R1W RTLNAME fir_c_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
