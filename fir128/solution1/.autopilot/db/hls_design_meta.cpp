...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("y_TKEEP", 4, hls_out, 1, "axis", "out_data", 1),
	Port_Property("y_TSTRB", 4, hls_out, 2, "axis", "out_data", 1),
	...
	Port_Property("x_TKEEP", 4, hls_in, 5, "axis", "in_data", 1),
	Port_Property("x_TSTRB", 4, hls_in, 6, "axis", "in_data", 1),
