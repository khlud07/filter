...
set id 1
set name fir_mac_muladd_5s_16s_27s_27_4_1
...
set ce_signed 0
set out_width 27
set arg_lists {i0 {5 1 +} i1 {16 1 +} m {21 1 +} i2 {27 1 +} p {27 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler fir_fir_Pipeline_MAC_Loop_c_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename shift_reg \
    op interface \
    ports { shift_reg_address0 { O 7 vector } shift_reg_ce0 { O 1 bit } shift_reg_q0 { I 16 vector } } \
} "
} else {
